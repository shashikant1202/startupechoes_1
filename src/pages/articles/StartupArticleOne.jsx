...
const StartupArticleOne = () => {
  const content = articlesContent['startups-1'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
      {/* Hero Section - Updated with the correct image */}
      <div className="relative h-[60vh] w-full">
        <img
          src={images.startups.post1}
          alt="How to Turn Your Startup Idea into a Successful Business"
          ...
          <div className="container mx-auto h-full flex flex-col justify-end px-4 pb-12">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-red-500 mb-4 hover:text-red-600 transition-colors duration-300">
                How to Turn Your Startup Idea into a Successful Business
              </h1>
              <p className="text-lg text-gray-200 mb-6">
                A comprehensive guide to transforming your business idea into reality, from validation to scaling.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Updated Author Info with new logo */}
          <div className="flex items-center bg-white dark:bg-gray-800 rounded-xl p-6 mb-12 shadow-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Feb 15, 2024</p>
              </div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
            ...
            {content.additionalResources && (
              <div className="mt-12 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">
                  Additional Resources
                </h2>
...
export default StartupArticleOne; 