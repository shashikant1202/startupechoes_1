...
const StartupArticleThree = () => {
  const content = articlesContent['startups-3'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
      ...
      <div className="relative h-[60vh] w-full">
        <img
          src={images.startups.post3}
          alt="Common Startup Mistakes and How to Avoid Them"
          ...
          <div className="container mx-auto h-full flex flex-col justify-end px-4 pb-12">
            <div className="max-w-4xl">
              ...
              <p className="text-lg text-gray-200 mb-6">
                Highlights pitfalls like poor market research, lack of funding, and weak team dynamics.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center bg-white dark:bg-gray-800 rounded-xl p-6 mb-12 shadow-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Feb 13, 2024</p>
              </div>
            </div>
          </div>
...
export default StartupArticleThree; 