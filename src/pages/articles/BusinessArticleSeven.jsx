...
const BusinessArticleSeven = () => {
  const content = articlesContent['business-7'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
      ...
      <div className="relative h-[60vh] w-full">
        <img
          src={images.business.post7}
          alt="Effective Leadership Strategies for Business Growth"
          ...
          <div className="container mx-auto h-full flex flex-col justify-end px-4 pb-12">
            <div className="max-w-4xl">
              ...
              <p className="text-lg text-gray-200 mb-6">
                Key leadership strategies that drive business growth and foster innovation.
              </p>
            </div>
          </div>
        </div>
...
export default BusinessArticleSeven; 