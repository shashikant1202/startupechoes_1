...
const StartupArticleFour = () => {
  const content = articlesContent['startups-4'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-200">
      ...
      <div className="relative h-[60vh] w-full">
        <img
          src={images.startups.post4}
          alt="Growth Hacking Strategies for Startups"
          ...
          <div className="container mx-auto h-full flex flex-col justify-end px-4 pb-12">
            <div className="max-w-4xl">
              ...
              <p className="text-lg text-gray-200 mb-6">
                Shares cost-effective marketing and growth strategies used by successful startups.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center bg-white dark:bg-gray-800 rounded-xl p-6 mb-12 shadow-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Feb 12, 2024</p>
              </div>
            </div>
          </div>
...
export default StartupArticleFour; 